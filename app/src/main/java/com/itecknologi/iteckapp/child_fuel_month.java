...
public class child_fuel_month extends Fragment {
    BarChart mBarChart;
    ...
    public child_fuel_month(ArrayList<BarEntry> arrayList, Float sum, ArrayList<String> keyArrayList, String env) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.child_fuel_month, container, false);
