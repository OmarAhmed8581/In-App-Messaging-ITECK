...
public class child_fuel_day extends Fragment {
    BarChart mBarChart;
    ...
    public child_fuel_day(ArrayList<BarEntry> arrayList, Float sum) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.child_fuel_day, container, false);
    ...
    private void barConfiguration() {
        ...
        CustomMarkerView mv = new CustomMarkerView(getContext(), R.layout.mileage_marker, "f");
