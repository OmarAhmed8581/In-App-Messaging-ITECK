...
public class child_horibar_frag_month extends Fragment {
    BarChart mBarChart;
    ...
    public child_horibar_frag_month(ArrayList<BarEntry> arrayList, Float sum, ArrayList<String> keyArrayList, String env) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.child_horibar_month, container, false);
    ...
    private void barConfiguration() {
        ...
        CustomMarkerView2 mv = new CustomMarkerView2(getContext(), R.layout.mileage_marker, keyArrayList, "m");
