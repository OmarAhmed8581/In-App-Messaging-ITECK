...
public class ParentFuel extends AppCompatActivity implements View.OnClickListener {

    private TabLayout tablayout;
    private ViewPager viewpager;
    private TextView x, y;
    private LinearLayout btnCall, btnDisclaimer;
    private TextView txtThisMonth, txtLastMonth, txtThisWeek, txtLastWeek, txtToday, txtYesterday;
    ArrayList<BarEntry> entriesToday;
    ArrayList<BarEntry> entriesYesterday;
    ArrayList<BarEntry> entriesThisWeek;
    ArrayList<BarEntry> entriesLastWeek;
    ArrayList<BarEntry> entriesThisMonth;
    ArrayList<BarEntry> entriesLastMonth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fuel_tab);
    ...
    private void getDataFromAPI(String id_vehicle, String ObjectId) {
        ...
        if (checkConnection()) {
            String url = "https://api.itecknologi.com/mobile/get_consolidated_fuelburned_report.php";
    ...
    private void getMonthData(JSONObject respObj) {
        ...
        vpAdapter.addFragment(new child_fuel_month(MonthlyData, ltr1, keyArrayList, "m"), "M");
    ...
    private void getP7Data(JSONObject respObj) {
        ...
        vpAdapter.addFragment(new child_fuel_week(past7Days, day2, ltr1, dateArrayListWeek), "W");
        p7FuelG = ltr1;
    ...
    private void getToday(JSONObject respObj) {
        ...
        Float ltr1 = (float) Math.round(d2 * 100) / 100;
        vpAdapter.addFragment(new child_fuel_day(HourlyData, ltr1), "D");
        p7FuelH = ltr1;
