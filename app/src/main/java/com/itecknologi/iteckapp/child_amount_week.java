...
public class child_amount_week extends Fragment {
    BarChart mBarChart;
    ...
    public child_amount_week(ArrayList<BarEntry> arrayList, String[] day2, Float sum, ArrayList<String> dateArrayList) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.child_amount_week, container, false);
...
//        xVals.add("S");
        ...
        CustomMarkerViewWeek mv = new CustomMarkerViewWeek(getContext(), R.layout.mileage_marker, dateArrayList, "a");
