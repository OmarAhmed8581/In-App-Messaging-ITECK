...
public class child_horibar_frag_day extends Fragment {
    BarChart mBarChart;
    ArrayList<BarEntry> arrayList;
    TextView txtSumHourly;
    Float sum;

    public child_horibar_frag_day(ArrayList<BarEntry> arrayList, Float sum) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.child_horibar_day, container, false);
