...
public class child_fuel_week extends Fragment {
    BarChart mBarChart;
    ...
    public child_fuel_week(ArrayList<BarEntry> arrayList, String[] day2, Float sum, ArrayList<String> dateArrayList) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.child_fuel_week, container, false);
    ...
    private void barConfiguration() {
        ...
        barDataSet.setColor(Color.parseColor("#3498dc"));
...
//        xVals.add("S");
        ...
        CustomMarkerViewWeek mv = new CustomMarkerViewWeek(getContext(), R.layout.mileage_marker, dateArrayList, "f");
