...
public class AVG_Child_Fuel extends Fragment {
    ...
    int[] MY_COLORS = {
            Color.parseColor("#26AAE1"),
            Color.parseColor("#2193C9"),
            Color.parseColor("#1D80B5"),
            Color.parseColor("#196CA0"),
            Color.parseColor("#15598D"),
            Color.parseColor("#114476"),
    };

    ArrayList<PieEntry> entries;
    HashMap<String, Float> hourlyMap = new HashMap<>();

    public AVG_Child_Fuel() {

    }

    public AVG_Child_Fuel(JSONObject jsonObject) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_a_v_g__child__fuel, container, false);
        ...
        try {
            ...
            String FuelCostSlabId = jsonObject.getString("FuelBurnedSlabId");
            int TotalVehicle = Math.round(Float.parseFloat(jsonObject.getString("TotalVehicle").toString()));

            todayData = jsonObject.getJSONObject("FuelBurned");
