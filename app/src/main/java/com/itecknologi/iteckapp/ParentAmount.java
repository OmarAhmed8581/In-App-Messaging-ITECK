...
public class ParentAmount extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amount_tab);
    ...
    private void getDataFromAPI(String id_vehicle, String ObjectId) {
        ...
        if (checkConnection()) {
            String url = "https://api.itecknologi.com/mobile/get_consolidated_fuelcost_report.php";
    ...
    private void getMonthData(JSONObject respObj) {
        ...
        vpAdapter.addFragment(new child_amount_month(MonthlyData, ltr1, keyArrayList, "a"), "M");
    ...
    private void getP7Data(JSONObject respObj) {
        ...
        vpAdapter.addFragment(new child_amount_week(past7Days, day2, ltr1, dateArrayListWeek), "W");
        p7FuelG = ltr1;
    ...
    private void getToday(JSONObject respObj) {
        ...
        Float d2 = new Float(sum);
        sumHourly = d2.intValue();
        Float ltr1 = (float) Math.round(d2 * 100) / 100;

        vpAdapter.addFragment(new child_amount_day(HourlyData, ltr1), "D");
    ...
    private void setTextOnTextIds(JSONObject respObj) {
        try {
            ...
            if (valYesterday > todayVal) {
                txtRecent.setText("You have spent "
                        .concat(Math.round(valYesterday - todayVal) +
                                " PKR less than yesterday"));
